...
export class ValidationErrorComponent {
  ...
  getMessage() {
    ...
    if (errors.minlength)
      return this.translate.translate('message.lengthGreaterThanOrEqual', {
        value: controlName,
        length: errors.maxlength.requiredLength,
      });

    if (errors.maxlength)
      return this.translate.translate('message.lengthLessThanOrEqual', {
        value: controlName,
        length: errors.maxlength.requiredLength,
      });
    ...
    if (errors.facebook) return this.translate.translate('validation.facebook');
    ...
    if (errors.regex) {
      return this.translate.translate('validation.regex', {
        controlName: this.translate.translate(`form.validation.${controlName}`),
      });
    }
